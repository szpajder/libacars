...
static la_asn1_formatter const la_asn1_cpdlc_json_formatter_table[] = {
	...
	{ .type = &asn_DEF_FANSAircraftFlightIdentification, .format = la_asn1_format_OCTET_STRING_as_json, .label = "ac_flight_id" },
	{ .type = &asn_DEF_FANSAircraftType, .format = la_asn1_format_OCTET_STRING_as_json, .label = "ac_type" },
	{ .type = &asn_DEF_FANSAirport, .format = la_asn1_format_OCTET_STRING_as_json, .label = "airport" },
	{ .type = &asn_DEF_FANSAirportDeparture, .format = la_asn1_format_OCTET_STRING_as_json, .label = "airport_dep" },
	{ .type = &asn_DEF_FANSAirportDestination, .format = la_asn1_format_OCTET_STRING_as_json, .label = "airport_dst" },
	{ .type = &asn_DEF_FANSAirwayIdentifier, .format = la_asn1_format_OCTET_STRING_as_json, .label = "airway_id" },
	{ .type = &asn_DEF_FANSAirwayIntercept, .format = la_asn1_format_OCTET_STRING_as_json, .label = "airway_intercept" },
	...
	{ .type = &asn_DEF_FANSATISCode, .format = la_asn1_format_OCTET_STRING_as_json, .label = "atis_code" },
	...
	{ .type = &asn_DEF_FANSFixName, .format = la_asn1_format_OCTET_STRING_as_json, .label = "fix" },
	...
	{ .type = &asn_DEF_FANSFreeText, .format = la_asn1_format_OCTET_STRING_as_json, .label = "free_text" },
	...
	{ .type = &asn_DEF_FANSFrequencysatchannel, .format = la_asn1_format_OCTET_STRING_as_json, .label = "sat_channel" },
	...
	{ .type = &asn_DEF_FANSICAOfacilityDesignation, .format = la_asn1_format_OCTET_STRING_as_json, .label = "icao_facility_designation" },
	...
	{ .type = &asn_DEF_FANSICAOFacilityName, .format = la_asn1_format_OCTET_STRING_as_json, .label = "icao_facility_name" },
	...
	{ .type = &asn_DEF_FANSNavaid, .format = la_asn1_format_OCTET_STRING_as_json, .label = "navaid" },
	...
	{ .type = &asn_DEF_FANSProcedure, .format = la_asn1_format_OCTET_STRING_as_json, .label = "procedure" },
	...
	{ .type = &asn_DEF_FANSProcedureTransition, .format = la_asn1_format_OCTET_STRING_as_json, .label = "procedure_transition" },
	...
	{ .type = &asn_DEF_FANSSupplementaryInformation, .format = la_asn1_format_OCTET_STRING_as_json, .label = "supplementary_info" },
	...
	{ .type = &asn_DEF_FANSTrackName, .format = la_asn1_format_OCTET_STRING_as_json, .label = "trk_name" },
