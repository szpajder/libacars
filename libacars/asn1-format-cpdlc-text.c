...
static la_asn1_formatter const la_asn1_cpdlc_text_formatter_table[] = {
	...
	{ .type = &asn_DEF_FANSAircraftFlightIdentification, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Flight ID" },
	{ .type = &asn_DEF_FANSAircraftType, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Aircraft type" },
	{ .type = &asn_DEF_FANSAirport, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Airport" },
	{ .type = &asn_DEF_FANSAirportDeparture, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Departure airport" },
	{ .type = &asn_DEF_FANSAirportDestination, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Destination airport" },
	{ .type = &asn_DEF_FANSAirwayIdentifier, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Airway ID" },
	{ .type = &asn_DEF_FANSAirwayIntercept, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Airway intercept" },
	...
	{ .type = &asn_DEF_FANSATISCode, .format = la_asn1_format_OCTET_STRING_as_text, .label = "ATIS code" },
	...
	{ .type = &asn_DEF_FANSFixName, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Fix" },
	...
	{ .type = &asn_DEF_FANSFreeText, .format = la_asn1_format_OCTET_STRING_as_text, .label = NULL },
	...
	{ .type = &asn_DEF_FANSICAOfacilityDesignation, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Facility designation" },
	...
	{ .type = &asn_DEF_FANSICAOFacilityName, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Facility Name" },
	...
	{ .type = &asn_DEF_FANSNavaid, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Navaid" },
	...
	{ .type = &asn_DEF_FANSProcedure, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Procedure name" },
	...
	{ .type = &asn_DEF_FANSProcedureTransition, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Procedure transition" },
	...
	{ .type = &asn_DEF_FANSSupplementaryInformation, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Supplementary information" },
	...
	{ .type = &asn_DEF_FANSTrackName, .format = la_asn1_format_OCTET_STRING_as_text, .label = "Track name" },
