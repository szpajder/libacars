...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_FANSLongitudeDirection_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_FANSLongitudeDirection;
extern const asn_INTEGER_specifics_t asn_SPC_FANSLongitudeDirection_specs_1;
...
jer_type_encoder_f FANSLongitudeDirection_encode_jer;
oer_type_decoder_f FANSLongitudeDirection_decode_oer;
oer_type_encoder_f FANSLongitudeDirection_encode_oer;
per_type_decoder_f FANSLongitudeDirection_decode_uper;
per_type_encoder_f FANSLongitudeDirection_encode_uper;
per_type_decoder_f FANSLongitudeDirection_decode_aper;
per_type_encoder_f FANSLongitudeDirection_encode_aper;
