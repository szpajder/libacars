...
int
FANSAltitudeFlightLevelMetric_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_FANSAltitudeFlightLevelMetric_constr_1 CC_NOTUSED = {
	{ 2, 1 }	/* (100..2000) */,
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_FANSAltitudeFlightLevelMetric_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_FANSAltitudeFlightLevelMetric = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_FANSAltitudeFlightLevelMetric_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
