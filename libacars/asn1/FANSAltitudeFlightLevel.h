...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_FANSAltitudeFlightLevel_constr_1;
...
jer_type_encoder_f FANSAltitudeFlightLevel_encode_jer;
oer_type_decoder_f FANSAltitudeFlightLevel_decode_oer;
oer_type_encoder_f FANSAltitudeFlightLevel_encode_oer;
per_type_decoder_f FANSAltitudeFlightLevel_decode_uper;
per_type_encoder_f FANSAltitudeFlightLevel_encode_uper;
per_type_decoder_f FANSAltitudeFlightLevel_decode_aper;
per_type_encoder_f FANSAltitudeFlightLevel_encode_aper;
