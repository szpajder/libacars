...
static asn_oer_constraints_t asn_OER_type_FANSATWAltitudeTolerance_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_FANSATWAltitudeTolerance_constr_1 CC_NOTUSED = {
...
const asn_INTEGER_specifics_t asn_SPC_FANSATWAltitudeTolerance_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_FANSATWAltitudeTolerance = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_FANSATWAltitudeTolerance_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
