...
int
FANSAltimeterEnglish_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_FANSAltimeterEnglish_constr_1 CC_NOTUSED = {
	{ 2, 1 }	/* (2200..3200) */,
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_FANSAltimeterEnglish_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_FANSAltimeterEnglish = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_FANSAltimeterEnglish_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
