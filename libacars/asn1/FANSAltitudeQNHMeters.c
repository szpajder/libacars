...
int
FANSAltitudeQNHMeters_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_FANSAltitudeQNHMeters_constr_1 CC_NOTUSED = {
	{ 2, 1 }	/* (0..16000) */,
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_FANSAltitudeQNHMeters_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_FANSAltitudeQNHMeters = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_FANSAltitudeQNHMeters_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
