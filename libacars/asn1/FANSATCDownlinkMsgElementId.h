...
struct FANSPositionReport;
struct FANSRemainingFuelRemainingSouls;
struct FANSTimeDistanceToFromPosition;
...
typedef struct FANSATCDownlinkMsgElementId {
	...
	union FANSATCDownlinkMsgElementId_u {
		...
		NULL_t	 dM4NULL;
		NULL_t	 dM5NULL;
		struct FANSAltitude	*dM6Altitude;
		struct FANSAltitudeAltitude	*dM7AltitudeAltitude;
		struct FANSAltitude	*dM8Altitude;
		struct FANSAltitude	*dM9Altitude;
		struct FANSAltitude	*dM10Altitude;
		struct FANSPositionAltitude	*dM11PositionAltitude;
		struct FANSPositionAltitude	*dM12PositionAltitude;
		struct FANSTimeAltitude	*dM13TimeAltitude;
		struct FANSTimeAltitude	*dM14TimeAltitude;
		struct FANSDistanceOffsetDirection	*dM15DistanceOffsetDirection;
		struct FANSPositionDistanceOffsetDirection	*dM16PositionDistanceOffsetDirection;
		struct FANSTimeDistanceOffsetDirection	*dM17TimeDistanceOffsetDirection;
		struct FANSSpeed	*dM18Speed;
		struct FANSSpeedSpeed	*dM19SpeedSpeed;
		NULL_t	 dM20NULL;
		struct FANSFrequency	*dM21Frequency;
		struct FANSPosition	*dM22Position;
		struct FANSProcedureName	*dM23ProcedureName;
		struct FANSRouteClearance	*dM24RouteClearance;
		NULL_t	 dM25NULL;
		struct FANSPositionRouteClearance	*dM26PositionRouteClearance;
		struct FANSDistanceOffsetDirection	*dM27DistanceOffsetDirection;
		struct FANSAltitude	*dM28Altitude;
		struct FANSAltitude	*dM29Altitude;
		struct FANSAltitude	*dM30Altitude;
		struct FANSPosition	*dM31Position;
		struct FANSAltitude	*dM32Altitude;
		struct FANSPosition	*dM33Position;
		struct FANSSpeed	*dM34Speed;
		struct FANSDegrees	*dM35Degrees;
		struct FANSDegrees	*dM36Degrees;
		struct FANSAltitude	*dM37Altitude;
		struct FANSAltitude	*dM38Altitude;
		struct FANSSpeed	*dM39Speed;
		struct FANSRouteClearance	*dM40RouteClearance;
		NULL_t	 dM41NULL;
		struct FANSPosition	*dM42Position;
		struct FANSTime	*dM43Time;
		struct FANSPosition	*dM44Position;
		struct FANSPosition	*dM45Position;
		struct FANSTime	*dM46Time;
		struct FANSBeaconCode	*dM47BeaconCode;
		struct FANSPositionReport	*dM48PositionReport;
		struct FANSSpeed	*dM49Speed;
		struct FANSSpeedSpeed	*dM50SpeedSpeed;
		NULL_t	 dM51NULL;
		NULL_t	 dM52NULL;
		NULL_t	 dM53NULL;
		struct FANSAltitude	*dM54Altitude;
		NULL_t	 dM55NULL;
		NULL_t	 dM56NULL;
		struct FANSRemainingFuelRemainingSouls	*dM57RemainingFuelRemainingSouls;
		NULL_t	 dM58NULL;
		struct FANSPositionRouteClearance	*dM59PositionRouteClearance;
		struct FANSDistanceOffsetDirection	*dM60DistanceOffsetDirection;
		struct FANSAltitude	*dM61Altitude;
		...
		NULL_t	 dM69NULL;
		struct FANSDegrees	*dM70Degrees;
		struct FANSDegrees	*dM71Degrees;
		struct FANSAltitude	*dM72Altitude;
		FANSVersionNumber_t	 dM73VersionNumber;
		NULL_t	 dM74NULL;
		NULL_t	 dM75NULL;
		struct FANSAltitudeAltitude	*dM76AltitudeAltitude;
		struct FANSAltitudeAltitude	*dM77AltitudeAltitude;
		struct FANSTimeDistanceToFromPosition	*dM78TimeDistanceToFromPosition;
		FANSATISCode_t	 dM79ATISCode;
		struct FANSDistanceOffsetDirection	*dM80DistanceOffsetDirection;
		NULL_t	 dM81NULL;
		NULL_t	 dM82NULL;
		NULL_t	 dM83NULL;
		NULL_t	 dM84NULL;
...
extern asn_CHOICE_specifics_t asn_SPC_FANSATCDownlinkMsgElementId_specs_1;
extern asn_TYPE_member_t asn_MBR_FANSATCDownlinkMsgElementId_1[129];
extern asn_per_constraints_t asn_PER_type_FANSATCDownlinkMsgElementId_constr_1;
