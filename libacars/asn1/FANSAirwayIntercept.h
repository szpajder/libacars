...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_FANSAirwayIntercept_constr_1;
...
jer_type_encoder_f FANSAirwayIntercept_encode_jer;
oer_type_decoder_f FANSAirwayIntercept_decode_oer;
oer_type_encoder_f FANSAirwayIntercept_encode_oer;
per_type_decoder_f FANSAirwayIntercept_decode_uper;
per_type_encoder_f FANSAirwayIntercept_encode_uper;
per_type_decoder_f FANSAirwayIntercept_decode_aper;
per_type_encoder_f FANSAirwayIntercept_encode_aper;
