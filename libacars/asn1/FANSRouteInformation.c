...
asn_TYPE_member_t asn_MBR_FANSRouteInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct FANSRouteInformation, choice.publishedIdentifier),
	...
	{ ATF_POINTER, 0, offsetof(struct FANSRouteInformation, choice.latitudeLongitude),
	...
	{ ATF_POINTER, 0, offsetof(struct FANSRouteInformation, choice.placeBearingPlaceBearing),
	...
	{ ATF_POINTER, 0, offsetof(struct FANSRouteInformation, choice.placeBearingDistance),
	...
	{ ATF_POINTER, 0, offsetof(struct FANSRouteInformation, choice.trackDetail),
